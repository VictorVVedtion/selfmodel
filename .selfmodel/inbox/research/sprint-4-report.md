      ...
      'User-Agent': 'GeminiCLI/0.35.3/gemini-3.1-pro-preview (darwin; arm64; antigravity) google-api-nodejs-client/9.15.1',
    ...
    config: {
      ...
      'server-timing': 'gfet4t7; dur=6464',
      'x-cloudaicompanion-trace-id': 'f5c71c801f39d970',
    ...
    config: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      'server-timing': 'gfet4t7; dur=5523',
      'x-cloudaicompanion-trace-id': '98ca3c35f387428a',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
基于您的需求，以下是关于 Claude Code 的 `CLAUDE.md` 指令文件使用英文 vs 中文的调研报告：
